...
REM First run: install dependencies (Anthropic SDK for the Claude Sonnet tutor, mysql2, sql.js).
...
echo   Tutor model: Claude Sonnet 5, high reasoning ^(set ANTHROPIC_API_KEY in serve.config.json or env^)
